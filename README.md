...
|---|---|---|---|
| 01 | SQL Fundamentals | SELECT, WHERE, ORDER BY, LIMIT, string functions | LC50 §1 Select |
| 02 | Filtering & Conditionals | IN, BETWEEN, LIKE, REGEXP, CASE, NULL handling | LC50 §1 / §7 |
...
| 07 | Performance & Indexing | EXPLAIN, indexes, statistics, tuning, stored procedures | off-spine |
| 08 | Advanced Analytics | Pivot, lateral, advanced frames, sampling, triggers | off-spine |
...
[`content/problems.json`](content/problems.json) — **108 sourced problems** across 9 modules.
...
| [LeetCode Advanced SQL 50](https://leetcode.com/studyplan/premium-sql-50/) | L3/L4 spine extension — *not yet enumerated* | 50 | Premium |
...
| [PGExercises](https://pgexercises.com/) | Postgres-native + recursive (L2/L3) | — | Free |
