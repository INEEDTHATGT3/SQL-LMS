/**
 * Creates progress tracker configuration for a skill
 * This generates the recall.js configuration at build time
 */

export function createProgressTracker(config) {
  const { storageKey = 'skill_progress_v1' } = config;
  
  return `/* Progress Tracker for ${config.skillName || 'Skill'}
